...
SET TARGET_NAME=AuraborosEngine
...
FOR /f %%j IN ('dir /s /b %SRC_FOLDER%*.cpp') DO (
   ...
   CL "!SRC_FILE!" /nologo /c /DWIN32 /DGLEW_STATIC /DTARGET_NAME=\"!TARGET_NAME!\" /EHsc /FS /Gd /MD /Fo!OBJ_FILE! /Fd%OBJ_FOLDER%%TARGET_NAME%.pdb
